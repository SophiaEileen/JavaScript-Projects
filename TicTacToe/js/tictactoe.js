//This variavle keeps track of whose turn it is. 
let activeplayer = 'X';
...
function placeXOro(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        //This condtion checks who's turn it is. 
        if (activeplayer === 'X') {
...
function checkWinConditions() {
    ...
    //This function checks if an array incldues 3 strings. It is used to check for
    //each win condition. 
...
//This function takes a string parameter of the path you set for
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        x = x1,
        //This variable stores temporary y axis data we update in out animation loop.
        y = y1; 
